...
class StockUniverse(Base):
    ...
    original_fmp_sector = Column(
        String(100), nullable=True
    )  # Preserve original FMP sector data
    ...
    def should_include_in_universe(self) -> bool:
        ...
        return (
            self.is_active
            and (self.is_micro_cap or self.is_small_cap)
            and self.meets_volume_criteria
            and self.meets_price_criteria
            and self.exchange in ["NASDAQ", "NYSE", "NYSEARCA"]
        )
