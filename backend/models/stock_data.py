...
class StockData(Base):
    ...
    def is_bullish_candidate(self) -> bool:
        ...
        return (
            ...
            and self.has_volume_confirmation
            and not self.is_extreme_gap  # Avoid exhausted moves
        )

    @property
    def is_bearish_candidate(self) -> bool:
        """Check if stock is a good bearish candidate"""
        return self.price_change_percent < 0 and self.has_volume_confirmation
    ...
    def update_performance_data(
        ...
        self.gap_percent = (
            (open_price - previous_close) / previous_close if previous_close > 0 else 0
        )
