...
def main():
    ...
    if test_suite == "all":
        ...
        return run_command("pytest tests/integration/ -v -m integration", "Integration Tests")
        ...
        return run_command("pytest tests/unit/test_health_routes.py -v", "Health Check Tests")
    
    elif test_suite == "sectors":
        return run_command("pytest tests/unit/test_sectors_routes.py -v", "Sector Tests")
        ...
        return run_command("pytest tests/ -v --cov=. --cov-report=html --cov-report=term-missing", "Tests with Coverage")
