...
class TestHealthRouter:
    ...
    def test_health_endpoint_response_time(self, client: TestClient):
        ...
        assert response_time < 5.0, f"Health check took {response_time}s, should be < 5s"
    ...
    def test_health_endpoint_caching(self, client: TestClient):
        ...
        assert response_time < 5.0, f"Cached health check took {response_time}s, should be < 5s" 