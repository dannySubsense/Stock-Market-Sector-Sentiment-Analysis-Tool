...
class TestSimpleE2E:
    ...
    async def test_simple_sectors_endpoint(self, async_client: AsyncClient):
        ...
        assert "total_sectors" in sectors_data, "Sectors response missing 'total_sectors' key"
    ...
    async def test_simple_stocks_endpoint(self, async_client: AsyncClient):
        ...
        assert "returned_count" in stocks_data, "Stocks response missing 'returned_count' key"
