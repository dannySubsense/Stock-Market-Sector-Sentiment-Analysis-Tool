...
async def database_health():
    ...
    try:
        ...
        return {"timestamp": datetime.utcnow().isoformat(), **db_info}
    except Exception as e:
        raise HTTPException(
...
async def redis_health():
    ...
    try:
        ...
        return {"timestamp": datetime.utcnow().isoformat(), **redis_info}
    except Exception as e:
        raise HTTPException(
...
async def api_health():
    ...
    try:
        ...
        return {"timestamp": datetime.utcnow().isoformat(), **api_info}
    except Exception as e:
        raise HTTPException(
...
async def check_api_health() -> Dict[str, Any]:
    ...
    status = {"status": "healthy", "apis": {}}

    # Check if credentials are available
    if not settings.credentials:
        return {"status": "unhealthy", "error": "No credentials configured", "apis": {}}
    ...
    try:
        ...
        status["apis"]["polygon"] = {"status": "error", "error": str(e)}
    ...
    try:
        ...
        status["apis"]["fmp"] = {"status": "error", "error": str(e)}
    ...
    try:
        ...
        status["apis"]["openai"] = {"status": "error", "error": str(e)}

    # Determine overall API health
    api_errors = [
        api
        for api in status["apis"].values()
        if api["status"] in ["error", "not_configured"]
    ]
    if api_errors:
