...
async def list_cached_keys(prefix: Optional[str] = None):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to list cached keys: {str(e)}")
...
async def clear_specific_cache(key: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to clear cache key: {str(e)}")
...
async def get_cache_performance():
    ...
    try:
        ...
        return {
            ...
            "optimization_opportunities": performance.get("optimization_opportunities", []),
            "timestamp": datetime.utcnow().isoformat()
        }
...
async def get_cache_access_patterns():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get cache access patterns: {str(e)}") 